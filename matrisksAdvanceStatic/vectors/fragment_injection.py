...
class Vector(VectorBase):
    ...
    def analyze(self) -> None:
        ...
        prog = re.compile(r"Landroid/support/v(\d*)/app/Fragment;")
        ...
        if list_Fragment_vulnerability_NonMethod_classes or list_Fragment_vulnerability_Method_OnlyReturnTrue_methods or list_Fragment_vulnerability_Method_NoIfOrSwitch_methods:
            ...
            self.writer.startWriter("FRAGMENT_INJECTION", LEVEL_CRITICAL, "Fragment Injection Vulnerability", output_string,
                               None, "BID 64208, CVE-2013-6271", vector_name=self.vector_name,
                               suggestion="When using PreferenceActivity, you must implement the isValidFragment() method to verify that the fragment specified by the user is valid. This is critical on versions prior to Android 4.4.",
