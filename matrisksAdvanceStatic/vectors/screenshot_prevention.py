...
class Vector(Vector):
    ...
    def analyze(self) -> None:
        ...
        path_code_for_preventing_screen_capture = self.analysis.find_methods(
            ...
            r"\(I I\)V")  # TODO might be changed due to Android Support library -> androidX
