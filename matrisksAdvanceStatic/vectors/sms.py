...
class Vector(Vector):
    ...
    def analyze(self) -> None:
        ...
        path_sms_sending = list(self.analysis.find_methods("Landroid/telephony/SmsManager;", "sendDataMessage",
                                                           r"\(Ljava/lang/String; Ljava/lang/String; S \[B Landroid/app/PendingIntent; Landroid/app/PendingIntent;\)V"))
        path_sms_sending.extend(self.analysis.find_methods("Landroid/telephony/SmsManager;", "sendMultipartTextMessage",
                                                           r"\(Ljava/lang/String; Ljava/lang/String; Ljava/util/ArrayList; Ljava/util/ArrayList; Ljava/util/ArrayList;\)V"))
        path_sms_sending.extend(self.analysis.find_methods("Landroid/telephony/SmsManager;", "sendTextMessage",
                                                           r"\(Ljava/lang/String; Ljava/lang/String; Ljava/lang/String; Landroid/app/PendingIntent; Landroid/app/PendingIntent;\)V"))
        ...
        if path_sms_sending:
            ...
            self.writer.startWriter("SENSITIVE_SMS", LEVEL_INFO, "Codes for Sending SMS",
                                    "Did not detect this app has code for sending SMS messages (sendDataMessage, sendMultipartTextMessage or sendTextMessage).", vector_name=self.vector_name)
