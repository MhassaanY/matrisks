...
class Vector(VectorBase):
    ...
    def analyze(self) -> None:
        ...
        path_HOSTNAME_INNER_VERIFIER = list(self.analysis.find_methods(
            "Ljavax/net/ssl/HttpsURLConnection;", "setDefaultHostnameVerifier", r"\(Ljavax/net/ssl/HostnameVerifier;\)V"))
        ...
        path_HOSTNAME_INNER_VERIFIER2 = list(self.analysis.find_methods(
            ...
            descriptor=r"\(Lorg/apache/http/conn/ssl/X509HostnameVerifier;\)V"))
        ...
        Please check the code inside these methods:"""
            ...
            self.writer.startWriter("SSL_CN1", LEVEL_CRITICAL,
                                    "SSL Implementation Checking (Verifying Host Name in Custom Classes, vector_name=self.vector_name)",
                                    output_string,
                                    ["SSL_Security"])
            ...
            self.writer.startWriter("SSL_CN1", LEVEL_INFO,
                                    ...
                                    "Self-defined HOSTNAME VERIFIER checking OK.", ["SSL_Security"], vector_name=self.vector_name)
        ...
        Please check the code inside these methods:"""
            ...
            self.writer.startWriter("SSL_CN2", LEVEL_CRITICAL,
                                    ...
                                    output_string, ["SSL_Security"], vector_name=self.vector_name)
        ...
        path_get_insecure = self.analysis.find_methods(
            ...
            r"\(I Landroid/net/SSLSessionCache;\)Ljavax/net/ssl/SSLSocketFactory;")
        ...
        path_http_host_scheme_http = self.analysis.find_methods(
            "Lorg/apache/http/HttpHost;", "<init>", r"\(Ljava/lang/String; I Ljava/lang/String;\)V")
        ...
        if list_http_host_scheme_http:
            self.writer.startWriter("SSL_DEFAULT_SCHEME_NAME", LEVEL_CRITICAL, "SSL Implementation Checking (HttpHost, vector_name=self.vector_name)",
            ...
            self.writer.startWriter("SSL_DEFAULT_SCHEME_NAME", LEVEL_INFO, "SSL Implementation Checking (HttpHost)",
                                    "DEFAULT_SCHEME_NAME for HttpHost check: OK", ["SSL_Security"], vector_name=self.vector_name)
    ...
    """, ["SSL_Security"], vector_name=self.vector_name)
            ...
            self.writer.startWriter("SSL_X509", LEVEL_INFO, "SSL Certificate Verification Checking",
                                    "Did not find vulnerable X509Certificate code.", ["SSL_Security"], vector_name=self.vector_name)
