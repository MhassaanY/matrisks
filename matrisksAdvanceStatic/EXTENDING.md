# Extending Matrisks Framework
In order to add your own vectors to the Matrisks Framework, please copy
...
Use `self.args` to access the `ConfigParser` arguments defined in `matrisks.py@parseArgument`.
