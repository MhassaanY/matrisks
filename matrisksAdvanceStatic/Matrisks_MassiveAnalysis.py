...
def parseArgument():
    parser = argparse.ArgumentParser(
        description='Framework: Android APK Vulnerability Scanner - Massive Tool')
...
def main():
    ...
    print()
    print("## Framework: Android APK Vulnerability Scanner - Massive Tool ##")
    print()
