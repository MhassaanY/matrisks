...
def parseArgument():
	parser = argparse.ArgumentParser(description='Framework: Android APK Vulnerability Summary Reporter (Parameter Condition: and)')
...
print("## Framework: Android APK Vulnerability Summary Reporter ##")
print()

if platform.system().lower() == "windows" :
	print("[Notice] The output format is not good in Windows console")

db_config_file = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'matrisks-db.cfg')

if not os.path.isfile(db_config_file) :
	print(('[ERROR] Framework DB config file not found: "' + db_config_file + '"'))
