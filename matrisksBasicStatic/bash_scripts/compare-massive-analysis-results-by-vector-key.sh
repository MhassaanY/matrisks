#######################
# Script to compare which applications are detected for a specific vector between two Matrisks massive analysis results.
#
# ARGUMENTS:
...
A=$(python ../../Matrisks/Matrisks_ReportByVectorKey.py -b $1 -t $2 -v $5 -l $6)
module load Python/3.6.6-foss-2018b
B=$(python ../Matrisks_ReportByVectorKey.py -b $3 -t $4 -v $5 -l $6)
