...
class Vector(VectorBase):
    ...
    def analyze(self) -> None:
        ...
        path_openOrCreateDatabase = self.analysis.find_methods(methodname="openOrCreateDatabase",
                                                               descriptor=r"\(Ljava/lang/String; I Landroid/database/sqlite/SQLiteDatabase$CursorFactory;\)Landroid/database/sqlite/SQLiteDatabase;")
        ...
        path_openOrCreateDatabase2 = self.analysis.find_methods(methodname="openOrCreateDatabase",
                                                                descriptor=r"\(Ljava/lang/String; I Landroid/database/sqlite/SQLiteDatabase$CursorFactory; Landroid/database/DatabaseErrorHandler;\)Landroid/database/sqlite/SQLiteDatabase;")
        ...
        path_getDir = self.analysis.find_methods(methodname="getDir",
                                                 descriptor=r"\(Ljava/lang/String; I\)Ljava/io/File;")
        ...
        path_getSharedPreferences = self.analysis.find_methods(methodname="getSharedPreferences",
                                                               descriptor=r"\(Ljava/lang/String; I\)Landroid/content/SharedPreferences;")
        ...
        path_openFileOutput = self.analysis.find_methods(methodname="openFileOutput",
                                                         descriptor=r"\(Ljava/lang/String; I\)Ljava/io/FileOutputStream;")
        ...
        external_storage_access_method_analysis_list = self.analysis.find_methods(
            "Landroid/os/Environment;", "getExternalStorageDirectory", r"\(\)Ljava/io/File;")
