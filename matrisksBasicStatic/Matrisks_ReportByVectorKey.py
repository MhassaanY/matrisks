...
def parseArgument():
	parser = argparse.ArgumentParser(description='Framework: Android APK Vulnerability Reporter by Vector Name')
...
print("## Framework: Android APK Vulnerability Reporter by Vector Name ##")
print()
